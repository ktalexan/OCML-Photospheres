...
class AzCognVisionRest(object):
    ...
    def __init__(self, blobAccount, blobKey, apiRegion, apiKey, containerName):
        ...
        # Setup cognitive vision credentials and client from Azure API
        self.credentials = CognitiveServicesCredentials(self.subscriptionKey)
        self.client = ComputerVisionClient(self.apiRegion, self.credentials)
